...
def start():
    ...
    if selected_track == 'Non-IT':
        active_assessment = Assessment.query.filter(Assessment.status == 'active', Assessment.title.like('%Non-IT%')).first()
    else:
        active_assessment = Assessment.query.filter(Assessment.status == 'active', Assessment.title.like('%IT%'), ~Assessment.title.like('%Non-IT%')).first()
