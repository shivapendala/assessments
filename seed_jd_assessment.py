...
def seed_assessment():
    ...
    with app.app_context():
        ...
        questions = [
            ...
            {
                "question": "Q9. Five friends A, B, C, D, and E sit in a row. A sits to the immediate left of B. C sits at one end. D sits between B and E. Who sits in the middle?",
                "option_a": "A",
                "option_b": "B",
                "option_c": "D",
                "option_d": "E",
            ...
            },
            {
                ...
                "option_b": "Java supports multiple inheritance using interfaces.",
